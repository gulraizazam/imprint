                  ...
                  <form enctype="multipart/form-data" action="{{ URL::to('/processContactUs')}}" method="post">
                    <input name="_token" value="{{ csrf_token() }}" type="hidden">
                      ...
                      <div class="input-group">                     
                       ...
                       <label for="email">@lang('website.Phone')</label>
                      <div class="input-group">                     
                        <input type="text"  name="phone" class="form-control" id="validationCustomUsername" placeholder="@lang('website.Enter Phone here').." aria-describedby="inputGroupPrepend" required>
                        <div class="help-block error-content invalid-feedback" hidden>@lang('website.Please enter your valid phone number')</div>
                      </div>  
                      ...
                      <button type="submit" class="btn btn-secondary swipe-to-top contactsubmit">@lang('website.Submit') <i class="fas fa-location-arrow"></i>                 
