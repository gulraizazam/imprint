<aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <?php
          ...
          ?>
        <li class="treeview {{ Request::is('admin/statscustomers') ? 'active' : '' }} {{ Request::is('admin/outofstock') ? 'active' : '' }} {{ Request::is('admin/statsproductspurchased') ? 'active' : '' }} { ">
          <a href="#">
